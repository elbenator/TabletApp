...
public class MenuPageCheesemilktea extends AppCompatActivity {
    Button MyOrderBtn, clearbutt;
    CardView ricebowl,clmilktea,alacarte,fd;
    ...
    com.example.tabletapp.item_selected_folder.item_selected_ad_milktea item_selected_ad_milktea;
    private recycler_adapter.RecyclerClick listener; // Para sa Clickable recycler view
    String zComp= "cheesecakemt"; // ETo yung category !!!!!!
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menu_page_cheesemilktea);
        ...
        LoadingDialog loadingDialog = new LoadingDialog( MenuPageCheesemilktea.this);
