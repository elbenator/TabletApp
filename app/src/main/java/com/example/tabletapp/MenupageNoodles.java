...
import com.example.tabletapp.item_selected_folder.item_selected_ad_noodles;
...
public class MenupageNoodles extends AppCompatActivity{
    Button MyOrderBtn, clearButt;
    CardView ricebowl,clmilktea,chmilktea,carte;
    ...
    String zComp= "friednoodles"; // ETo yung category !!!!!!

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menu_page_noodles);
        ...
        //loaddd
        LoadingDialog loadingDialog = new LoadingDialog( MenupageNoodles.this);
        ...
        clmilktea = findViewById(R.id.materialCardView4);
        ...
        String username = "tablet01"; // =================<<<<<< Kunwari username
        ...
        clmilktea.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), MenupageMilktea.class);
                startActivity(intent);
                overridePendingTransition(R.anim.fade_in,R.anim.fade_out);finish();
            }
        });
        ...
        reference1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot snapshot1: snapshot.getChildren()){
                    ...
                    if (zcat.equals(zComp) && show.equals("show")){
                        ...
                        String zprice = snapshot1.child("price").getValue().toString();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(MenupageNoodles.this, "Database Error", Toast.LENGTH_LONG).show();
            }});
    ...
    private void setOnClickListener() {
        ...
        listener = new recycler_adapter.RecyclerClick(){
            ...
            public void onClick(View v, int position) {
                ...
                Intent intent = new Intent(getApplicationContext(), item_selected_ad_noodles.class);
