...
import com.example.tabletapp.item_selected_folder.item_selected_ad_ricebowl;
...
public class MenupageRicebowl extends AppCompatActivity {
    Button MyOrderBtn, clearButt;
    CardView fd,clmilktea,chmilktea,carte;
    ...
    String zComp= "ricebowl"; // ETo yung category !!!!!!
//1st To Show Activity
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menu_page_ricebowl);
        ...
        //loaddd
        LoadingDialog loadingDialog = new LoadingDialog( MenupageRicebowl.this);
    ...
    private void setOnClickListener() {
        ...
        listener = new recycler_adapter.RecyclerClick(){
            ...
            public void onClick(View v, int position) {
                ...
                Intent intent = new Intent(getApplicationContext(), item_selected_ad_ricebowl.class);
