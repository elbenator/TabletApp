...
import com.example.tabletapp.item_selected_folder.item_selected;
...
public class MenuPageAlacarte extends AppCompatActivity {
    Button MyOrderBtn, clearbutt;
    CardView ricebowl,clmilktea,chmilktea,fd;
    RecyclerView dataList;
    List<String> titles;
    List<Integer> images;
    List<String> hiddenId;
    List<String> prices, showww;
    ...
    String zComp= "alacarte"; // ETo yung category !!!!!!
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menu_page_alacarte);
        ...
        //loaddd
        LoadingDialog loadingDialog = new LoadingDialog( MenuPageAlacarte.this);
    ...
    private void setOnClickListener() {
        ...
        listener = new recycler_adapter.RecyclerClick(){
            ...
            public void onClick(View v, int position) {
                ...
                Intent intent = new Intent(getApplicationContext(), item_selected.class);
