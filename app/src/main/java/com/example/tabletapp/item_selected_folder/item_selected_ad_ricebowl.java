...
public class item_selected_ad_ricebowl extends AppCompatActivity {
    //item selected
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.item_selected_ad_ricebowl);
        ...
        imageView4.setImageResource(imageNaCLASS.passthepic(itemHidID));
