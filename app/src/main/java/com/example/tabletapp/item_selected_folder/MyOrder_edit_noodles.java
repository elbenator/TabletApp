...
public class MyOrder_edit_noodles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_order_edit_noodles);
        ...
        addNoodCheck = findViewById(R.id.addNoodCheck);textViewCat = findViewById(R.id.textViewCat);
        ...
        //loaddd
        loadingDialog = new LoadingDialog( MyOrder_edit_noodles.this);
    ...
    //Set sa simula kapag may add On
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                 for(DataSnapshot snapshot1: snapshot.getChildren()){
                    ...
                    if (identifier.equals(itemHidID)){
                        ...
                        }else if (zname.equals(itemHidID+"AddNoodles")){
                            addNoodCheck.setChecked(true);
    ...
    public void saveChanges(String itemHidID, String orderID){
        ...
        if (addOntapaCheck.isChecked() || addNoodCheck.isChecked()|| !shark.equals(zero)|| !shang.equals(zero)|| !siomai.equals(zero)) {
           ...
           checkKungMayAddOn(orderID, itemHidID, shark, shang,siomai,quanty);
            ...
            reference = FirebaseDatabase.getInstance().getReference("preset_tablet");
            reference.child(orderID).child("order").child(itemHidID+"AddNoodles").removeValue();
            reference = FirebaseDatabase.getInstance().getReference("preset_tablet");
    ...
    public void checkKungMayAddOn(String tempOrderID, String itemId, String shark,String shang,String siomai,String qtyParent){
        ...
        reference = FirebaseDatabase.getInstance().getReference("preset_tablet");
        reference.child(tempOrderID).child("order").child(itemId+"AddNoodles").removeValue();
        reference = FirebaseDatabase.getInstance().getReference("preset_tablet");
    ...
    public void backNormal(){
        Intent intent = new Intent(MyOrder_edit_noodles.this, MyOrder_Page.class);
